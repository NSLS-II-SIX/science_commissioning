def test_rixscam_20210426():
    cycles = 100
    for i in range(0,cycles):
        yield from count([rixscam], num = 120)
        print(i)

def RuCl3_pristine_highRes_2():
    ext_vg = 15
    total_time = 600
    cyc = 30
    yield from rixs_one_energy_1(5,600,cyc,461.5,ext_vg, 'HighStatAndRes')

def RuCl3_flake_highRes():
    ext_vg = 15
    total_time = 600
    cyc = 42
    yield from rixs_one_energy_1(5,600,cyc,461.5,ext_vg, 'HighStatAndRes')
...
def RuCl3_Pristine_E_map_flake():
    ext_vg = 30
    total_time = 600
    cyc = 24
	# th = 15, tth = 90
    yield from pol_H(-3)
    cyc = 30
    yield from rixs_one_energy_1(5,600,23,461.5,ext_vg, 'HighStatAndRes')
    E = [463.3,465.2]#,407,408,409,410]
    for i in E:
        sec_x_pt = 5
        yield from rixs_one_energy_1(sec_x_pt,total_time,cyc,i,ext_vg, 'HighStatAndRes')
        print(i)

def RuCl3_Pristine_E_map():
    ext_vg = 30
    total_time = 600
    cyc = 24
	# th = 15, tth = 90
    yield from pol_H(-3)
    E = [461.5,463.3,465.2]#,407,408,409,410]
    for i in E:
        sec_x_pt = 5
        yield from rixs_one_energy_1(sec_x_pt,total_time,cyc,i,ext_vg, 'HighStatAndRes')
        print(i)
...
def hBN_th36_Emap_pristine_flake_second():
    ext_vg = 20
    total_time = 600
    cyc = 12
	# th = 15, tth = 90
    yield from pol_V(-3)
    E = [401.55,402.3,406.3]#,407,408,409,410]
    for i in E:
        sec_x_pt = 5
        yield from rixs_one_energy_1(sec_x_pt,total_time,cyc,i,ext_vg, 'HighStatAndRes')
        print(i)

def hBN_th36_Emap_pristine_flake():
    ext_vg = 20
    total_time = 600
    cyc = 6
	# th = 15, tth = 90
...
def hBN_th15_sample_3():
    ext_vg = 20
    total_time = 600
    cyc = 15
	# th = 15, tth = 90
    yield from pol_V(-3.0)
    E = [401.55,402.3,406.3] #,407,408,409,410]
    for i in E:
        sec_x_pt = 5
        yield from rixs_one_energy_1(sec_x_pt,total_time,cyc,i,ext_vg, 'HighStatAndRes')
